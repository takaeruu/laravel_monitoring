                        ...
                        <form action="{{ url('home/aksi_e_setting') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <?php if (isset($yogi->tab_icon) && !empty($yogi->tab_icon)): ?>
                                    <img src="<?= asset('images/' . htmlspecialchars($yogi->tab_icon)) ?>" alt="Favicon" width="30" height="30">
                                <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if (isset($yogi->logo_website) && !empty($yogi->logo_website)): ?>
                                    <img src="<?= asset('images/' . htmlspecialchars($yogi->logo_website)) ?>" alt="Logo Website" width="100" height="auto">
                                <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <?php if (isset($yogi->login_icon) && !empty($yogi->login_icon)): ?>
                                    <img src="<?= asset('images/' . htmlspecialchars($yogi->login_icon)) ?>" alt="Login Icon" width="100" height="40">
                                <?php endif; ?>
